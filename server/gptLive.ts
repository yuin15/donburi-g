...
const LOAN_SPEECH_GUARD = '貸し借りは双方の合意ごとに$5、時間延長は合意ごとに10秒。残高がなくても合意できる。自分から貸し借りを持ちかけたら、その提案に対するプレイヤーの返答を待つ。自分の提案や独り言、沈黙、提案前の返答をプレイヤーの同意にしない。プレイヤーの同意前に借りた・受け取ったと断定したり礼を言ったりしない。';
