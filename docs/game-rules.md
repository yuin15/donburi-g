...
The timing and spin limits above describe a normal 60-second round. The game also supports one accepted ten-second extension, after which the extended deadline applies. CPU play can show text choices for the extension and fictional $5 transfers. Optional voice sessions have server-validated spoken request handlers. No currency has real-world value.
