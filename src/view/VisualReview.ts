...
export type ReviewExample = 'cabinet-pose' | 'final-seconds' | 'extension-offered' | 'extension-accepted' | 'extension-rejected' | 'mutual-bonus' | 'text-bonus' | 'text-extend' | 'distraction-started' | 'distraction-recovered' | 'session-best' | 'mic-live' | 'mic-reply' | 'mic-muted' | 'mic-quiet' | 'normal' | 'small' | 'diagonal' | 'bell-cherry' | 'cherry-bell' | 'jackpot' | 'rival-jackpot' | 'both-jackpot' | 'quiet' | 'draw' | 'defeat' | 'final' | 'live-caption' | 'live-result-error' | 'live-result-closed' | 'rematch-ready';
