...
プレイヤーは1.1秒以上の間隔で、所持金がある限り最大55回、ライバルは2秒ごとに所持金がある限り回転します。右下のUPGRADEからチェリー6枚追加・7を1枚追加を購入できます。各商品は$5→$10→$15で最大3回、購入費は所持金から支払い、次の回転から反映されます。強化はプレイヤーのみ・その試合限りです。詳しくは[ゲーム規則](docs/game-rules.md)。
